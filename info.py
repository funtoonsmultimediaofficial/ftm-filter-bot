...
auth_channel = environ.get('AUTH_CHANNEL', '-1002242512710') # give your force subscribe channel id here else leave it blank
...
REFERAL_PREMEIUM_TIME = int(environ.get('REFERAL_PREMEIUM_TIME', LOG_CHANNEL))
