...
PICS = (environ.get('PICS', 'https://graph.org/file/de6773febcac8d3847411.jpg')).split() #SAMPLE PIC
NOR_IMG = environ.get("NOR_IMG", "https://graph.org/file/b69af2db776e4e85d21ec.jpg")
MELCOW_VID = environ.get("MELCOW_VID", "https://t.me/How_To_Open_Linkl")
SPELL_IMG = environ.get("SPELL_IMG", "https://te.legra.ph/file/15c1ad448dfe472a5cbb8.jpg")

# Admins, Channels & Users
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002151330842'))
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002213129805') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
reqst_channel = environ.get('REQST_CHANNEL_ID', '')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', ' -1002247963596')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://g:g@cluster0.x67mxqt.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/CINEMACOLLECTOROTT')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/How_To_Open_Linkl')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'CINEMACCBOTUPDATES') # Support Chat Link Without https:// or @
